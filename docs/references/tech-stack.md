...
- **typescript-eslint 8.54.0** - TypeScript 专用规则
...
### TypeScript 类型定义
- **@types/node 22.19.7** - Node.js 类型定义
...
- **happy-dom 20.3.9** - 轻量级 DOM 环境（性能优化）
...
### 端到端测试
- **@playwright/test 1.58.0** - 端到端测试框架
- **playwright 1.58.0** - Playwright 核心库
