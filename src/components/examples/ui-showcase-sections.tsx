  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Elegant toast notifications with theme integration and
    ...
    <Card>
      ...
      <CardContent>
        <Prose>
          ...
          <p>
            This is a demonstration of the <code>@tailwindcss/typography</code>{' '}
            plugin integrated with our theme system. The typography
            automatically adapts to light and dark themes.
          </p>
          <blockquote>
            &ldquo;Typography is the craft of endowing human language with a
            durable visual form.&rdquo; — Robert Bringhurst
          </blockquote>
          <ul>
          ...
          <p>
            The prose component ensures consistent styling across all content
            areas while maintaining excellent readability and accessibility
            standards.
          </p>
        </Prose>
      </CardContent>
