        ...
        <CardContent>
          <div className='space-y-6'>
            ...
            <div>
              ...
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <div className='h-4 w-4 rounded bg-gradient-to-r from-green-400 to-green-600'></div>
                  <Badge
                    variant='outline'
                    className='text-green-700'
                  >
                ...
                <div className='flex items-center gap-2'>
                  <div className='h-4 w-4 rounded bg-gradient-to-r from-yellow-400 to-yellow-600'></div>
                  <Badge
                    variant='outline'
                    className='text-yellow-700'
                  >
                ...
                <div className='flex items-center gap-2'>
                  <div className='h-4 w-4 rounded bg-gradient-to-r from-red-400 to-red-600'></div>
                  <Badge
                    variant='outline'
                    className='text-red-700'
                  >
            ...
            <div>
              ...
              <div className='space-y-2'>
                <div className='flex items-center gap-2'>
                  <div className='h-4 w-4 border-2 border-solid border-blue-500'></div>
                ...
                <div className='flex items-center gap-2'>
                  <div className='h-4 w-4 border-2 border-dashed border-orange-500'></div>
                ...
                <div className='flex items-center gap-2'>
                  <div className='h-4 w-4 border-2 border-dotted border-purple-500'></div>
                ...
                <div className='flex items-center gap-2'>
                  <div className='h-4 w-4 border-4 border-double border-red-500'></div>
